...
setwd("/Users/labrat/Library/CloudStorage/OneDrive-共享的库-Onedrive/Sweden/MTLS/summer intern/💻Research project/PSM-proteoform pipeline")


psm_url <- "https://kise-my.sharepoint.com/:t:/g/personal/isabelle_leo_ki_se/EQJWg_GHSt5GkU38754uPGEBGB8QL3nG9yHBrI9HD7r1oQ"
psm_path <- "target_psmtable.txt"
if (!file.exists(psm_path)) {
  install.packages("httr")
  library(httr)
  GET(psm_url, write_disk(psm_path, overwrite = TRUE), progress())
}
cll_psms <- read.delim(psm_path)
...
graphs_comms <- readRDS("graphs_comms 1.RDS")
...
hits_everything <- data.frame("id" = id_vector, "hgnc_symbol" = gene_vector,
                              "pAdj" = "N.D", #kept for the format to match but not relevant, there is no p value
                              "type" = "meltome" #label of the data source
)


cll_meta <- read.delim("all_cell_lines_sample_meta.txt")
...
saveRDS(all_from_CLL_default_normcenter, "/Users/labrat/Library/CloudStorage/OneDrive-共享的库-Onedrive/Sweden/MTLS/summer intern/💻Research project/PSM-proteoform pipeline/outputs/all_from_CLL_default_normcenter.RDS")
saveRDS(all_from_CLL_random_normcenter, "/Users/labrat/Library/CloudStorage/OneDrive-共享的库-Onedrive/Sweden/MTLS/summer intern/💻Research project/PSM-proteoform pipeline/outputs/all_from_CLL_random_normcenter.RDS")
saveRDS(all_from_CLL_gene_symbol_normcenter, "/Users/labrat/Library/CloudStorage/OneDrive-共享的库-Onedrive/Sweden/MTLS/summer intern/💻Research project/PSM-proteoform pipeline/outputs/all_from_CLL_gene_symbol_normcenter.RDS")
